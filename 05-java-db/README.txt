...
2. Criar o banco de dados:
   ...
   - psql -U postgres -f sql/postgresql_schema.sql
...
│
├── sql/
│   ├── postgresql_schema.sql    # Script para criar tabelas (PostgreSQL)
│   └── mysql_schema.sql          # Script para criar tabelas (MySQL)
│
├── src/main/java/JPA/
...
- Executar o script SQL apropriado:
  - PostgreSQL: sql/postgresql_schema.sql
  - MySQL: sql/mysql_schema.sql
